 ...
 * Description:            		It is used to ADD Diagnostic Center into the DiagnosticCenter Entity table.
...
***************************************************************************************************/
	 ...
	 * Description:            		It is used to GET Diagnostic Center by using center Id.
	 ...
	 * @PathVariable:               Used for data passed in the URI and transfer its values to parameter variables.
	 * Created By                   Sai Pavan Gajjela
	 * Created Date                 30-MAR-2021                            
	...
	***************************************************************************************************/
	 ...
	 * Description:            		It is used UPDATE Diagnostic Center details.
	...
	***************************************************************************************************/
	 ...
	 * Description:            		It is used to GET test details by using center Id, test name.
	 * @param				        Diagnostic center Id.
	...
	***************************************************************************************************/
	...
	/***************************************************************************************************
	 * Method:                 		addTest
	 * Description:            		It is used to ADD Test into the DiagnosticCenter Entity table.
	 * @param				        Diagnostic Center Id.
	...
	***************************************************************************************************/
	 ...
	 * Description:            		It is used to GET Diagnostic Center by center Name.
	...
	***************************************************************************************************/
	 ...
	 * Description:            		It is used to DELETE Diagnostic Center by center ID.
	 * @param				        Diagnostic center id.
	 * @returns					    Diagnostic Center with given center id.
	...
	***************************************************************************************************/
	 ...
	 * Description:            		It is used to GET list of appointments by center Name.
	 * @param				        Diagnostic center name.
